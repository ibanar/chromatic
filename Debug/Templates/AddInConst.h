...
Version: 2.0
------------------------------------
(C) Copyright 2001-2009 Franck Charlet.
------------------------------------ */
...
HWND (CALLBACK *WACreateSplashDialog)(long, long, long, long, char *, HWND, HMENU, HICON, void (CALLBACK *)(HWND), WNDPROC, long, long, long);
long (CALLBACK *WACreateModalDialog)(long, long, long, long, HWND, DLGPROC, long, long);
HWND (CALLBACK *WACreateDialog)(long, long, long, long, HWND, HMENU, HICON, char *, void (CALLBACK *)(HWND), WNDPROC, long, long, long);
HWND (CALLBACK *WACreateSplitter)(long, long, long, long, LPSPLITTERDAT, WNDPROC);
HWND (CALLBACK *WACreateMDIDialog)(long, long, long, long, HWND, HMENU, HICON, char *, void (CALLBACK *)(HWND), WNDPROC, long, long);
HWND (CALLBACK *WACreateMDIChildDialog)(HWND, char *, HICON, void (CALLBACK *)(HWND), WNDPROC, long, long, char *);
HWND (CALLBACK *WACreateToolBar)(long, long, long, long, HWND, HIMAGELIST, long, long, long, long, long);
HIMAGELIST (CALLBACK *WACreateImageList)(long, long, long);
HWND (CALLBACK *WACreateSysTab)(long, long, long, long, HWND, long, WNDPROC, HIMAGELIST, long);
HWND (CALLBACK *WACreateTrackBar)(long, long, long, long, HWND, long, WNDPROC, long, long, long);
HWND (CALLBACK *WACreateUpDown)(long, long, long, long, HWND, long, WNDPROC, long);
HWND (CALLBACK *WACreateProgressBar)(long, long, long, long, HWND, long, WNDPROC, long, long, long);
HWND (CALLBACK *WACreateStatusBar)(char *, long, HWND, long, WNDPROC, long);
HWND (CALLBACK *WACreateColorBox)(long, long, long, long, HWND, long, COLORREF, long);
LPGRIPBOXDAT (CALLBACK *WACreateGripBox)(long, long, long, long, HWND, long, COLORREF, long);
HWND (CALLBACK *WACreateLabel)(long, long, long, long, HWND, char *, long, WNDPROC, long, HFONT);
HWND (CALLBACK *WACreatePictureBox)(long, long, long, long, HWND, HGDIOBJ, long, long, WNDPROC, long);
HWND (CALLBACK *WACreateFrame)(long, long, long, long, HWND, char *, long, WNDPROC, long);
HWND (CALLBACK *WACreateButton)(long, long, long, long, HWND, char *, long, long, HICON, WNDPROC, long, long);
HWND (CALLBACK *WACreateIPBox)(long, long, long, long, HWND, long, long, WNDPROC, long, long, HFONT);
HWND (CALLBACK *WACreateRichTextBox)(long, long, long, long, HWND, char *, long, WNDPROC, long, long);
HWND (CALLBACK *WACreateHexBox)(long, long, long, long, HWND, char *, long, long, long, long);
HWND (CALLBACK *WACreateCheckBox)(long, long, long, long, HWND, char *, long, WNDPROC, long, long);
HWND (CALLBACK *WACreateRebar)(long, long, long, long, HWND, WNDPROC, long, long);
HWND (CALLBACK *WACreatePager)(long, long, long, long, HWND, HWND, long, long);
HWND (CALLBACK *WACreateClient)(HWND, HMENU, HICON);
HWND (CALLBACK *WACreateRadioButton)(long, long, long, long, HWND, char *, long, WNDPROC, long);
HWND (CALLBACK *WACreateListView)(long, long, long, long, HWND, long, HIMAGELIST, WNDPROC, long, long, long);
HWND (CALLBACK *WACreateTreeView)(long, long, long, long, HWND, long, HIMAGELIST, WNDPROC, long, long);
HWND (CALLBACK *WACreateComboBox)(long, long, long, long, HWND, char *, long, WNDPROC, long);
HWND (CALLBACK *WACreateListBox)(long, long, long, long, HWND, long, WNDPROC, long, long, long);
HWND (CALLBACK *WACreateScrollBar)(long, long, long, long, HWND, long, WNDPROC, long);
HWND (CALLBACK *WACreateDumpBox)(long, long, long, long, HWND, long, HFONT, long, long, long, long, WNDPROC, long, long);
long (CALLBACK *WACreateStockModalDialog)(long, long, long, long, long, HWND, char *, DLGPROC, long);
HWND (CALLBACK *WACreateTextBox)(long, long, long, long, HWND, char *, long, WNDPROC, long, long);
HWND (CALLBACK *WACreateDockingBox)(char *, WNDPROC);
...
long (CALLBACK *WAToolBarAddButton)(HWND, char *, long, long, long, long, long);
long (CALLBACK *WAToolBarGetButton)(HWND, long, LPTBBUTTON);
long (CALLBACK *WAToolBarGetButtonXSize)(HWND);
long (CALLBACK *WAToolBarGetButtonYSize)(HWND);
long (CALLBACK *WAToolBarGetButtonsCount)(HWND);
long (CALLBACK *WAToolBarGetRowsCount)(HWND);
HIMAGELIST (CALLBACK *WAToolBarGetImagelist)(HWND);
long (CALLBACK *WAToolBarAddSeparator)(HWND, long);
long (CALLBACK *WAToolBarGetNotifiedToolTip)(long);
long (CALLBACK *WAToolBarGetNotifiedDropDownItem)(long);
void (CALLBACK *WAToolBarDisplayToolTip)(char *, long);
long (CALLBACK *WAToolBarResize)(HWND);
long (CALLBACK *WAToolBarSetButtonPressed)(HWND, long, long);
long (CALLBACK *WAToolBarSetButtonChecked)(HWND, long, long);
long (CALLBACK *WAToolBarSetButtonEnabled)(HWND, long, long);
long (CALLBACK *WAToolBarIsButtonPressed)(HWND, long);
long (CALLBACK *WAToolBarIsButtonChecked)(HWND, long);
long (CALLBACK *WAToolBarDisplayPopupMenu)(HWND, long, HMENU, HWND);
long (CALLBACK *WAToolBarGetXSize)(HWND);
long (CALLBACK *WAToolBarGetYSize)(HWND);
long (CALLBACK *WAToolBarGetButtonXPosition)(HWND, long);
long (CALLBACK *WAToolBarGetXYSize)(HWND, LPSIZE);
long (CALLBACK *WAToolBarGetRealPos)(HWND, LPPOINT);
long (CALLBACK *WAToolBarGetButtonXYPos)(HWND, long, LPPOINT);
long (CALLBACK *WAToolBarGetButtonIndexXSize)(HWND, long);
long (CALLBACK *WAToolBarGetXPadding)(HWND);
long (CALLBACK *WAToolBarGetYPadding)(HWND);
long (CALLBACK *WAToolBarGetNotifiedHotItem)(long);
long (CALLBACK *WAToolBarRemoveButton)(HWND, long);
long (CALLBACK *WAToolBarSetButtonBitmap)(HWND, long, long);
void (CALLBACK *WAImageListDestroy)(HIMAGELIST);
long (CALLBACK *WAImageListAddIcon)(HIMAGELIST, long);
long (CALLBACK *WAImageListGetIconsCount)(HIMAGELIST);
HICON (CALLBACK *WAImageListGetIcon)(HIMAGELIST, long);
long (CALLBACK *WASysTabAddItem)(HWND, char *,long, long);
long (CALLBACK *WASysTabGetCurrentItem)(HWND);
HIMAGELIST (CALLBACK *WASysTabGetImagelist)(HWND);
long (CALLBACK *WASysTabSetCurrentItem)(HWND, long);
long (CALLBACK *WASysTabSetFocusItem)(HWND, long);
long (CALLBACK *WASysTabHighLightItem)(HWND, long, long);
long (CALLBACK *WASysTabItemsCount)(HWND);
long (CALLBACK *WASysTabGetRowsCount)(HWND);
long (CALLBACK *WASysTabSetSeparators)(HWND, long);
long (CALLBACK *WASysTabSetItemsSize)(HWND, long, long);
long (CALLBACK *WASysTabRemoveItem)(HWND, long);
long (CALLBACK *WASysTabSetMinWidth)(HWND, long);
long (CALLBACK *WASysTabSetPadding)(HWND, long, long);
long (CALLBACK *WATrackBarSetRange)(HWND, long, long, long);
long (CALLBACK *WATrackBarSetPos)(HWND, long);
long (CALLBACK *WATrackBarGetPos)(HWND);
long (CALLBACK *WATrackBarSetTicks)(HWND, long);
HWND (CALLBACK *WATrackBarGetToolTips)(HWND);
long (CALLBACK *WAProgressBarSetRange)(HWND, long, long);
long (CALLBACK *WAProgressBarSetRelPos)(HWND, long);
long (CALLBACK *WAStatusBarSetParts)(HWND, long, long *);
long (CALLBACK *WAStatusBarSetText)(HWND, long, long, char *, long);
long (CALLBACK *WAStatusBarGetYSize)(HWND);
COLORREF (CALLBACK *WAColorBoxGetColor)(HWND);
long (CALLBACK *WAColorBoxSetColor)(HWND, COLORREF);
...
HGDIOBJ (CALLBACK *WALabelGetImage)(HWND, long);
long (CALLBACK *WAPictureBoxChangeIcon)(HWND, HICON);
long (CALLBACK *WAPictureBoxChangeImage)(HWND, HANDLE);
long (CALLBACK *FrameRefreshToolbar)(HWND);
long (CALLBACK *WAButtonSetIcon)(HWND, long, HICON);
HANDLE (CALLBACK *WAButtonGetImage)(HWND, long);
long (CALLBACK *WAButtonGetState)(HWND);
...
long (CALLBACK *WATextBoxGetLen)(HWND);
long (CALLBACK *WATextBoxSetMaxLen)(HWND, long);
long (CALLBACK *WATextBoxGetMaxLen)(HWND);
long (CALLBACK *WATextBoxGetTextHandle)(HWND);
void (CALLBACK *WATextBoxAddText)(HWND, char *);
long (CALLBACK *WATextBoxSelText)(HWND, long);
long (CALLBACK *WATextBoxRemoveSel)(HWND);
long (CALLBACK *WATextBoxSetCaretPos)(HWND, long);
long (CALLBACK *WATextBoxLinesCount)(HWND);
long (CALLBACK *WATextBoxGetMarginWidth)(HWND);
long (CALLBACK *WATextBoxGetFirstVisibleLine)(HWND);
long (CALLBACK *WATextBoxIsModified)(HWND);
long (CALLBACK *WATextBoxGetCurrentOptions)(HWND);
char * (CALLBACK *WATextBoxGetPasswordChar)(HWND);
long (CALLBACK *WATextBoxSetPasswordChar)(HWND, char *);
long (CALLBACK *WATextBoxGetSelection)(HWND);
long (CALLBACK *WATextBoxGetScrollPos)(HWND);
long (CALLBACK *WATextBoxGetBreakProcAddress)(HWND);
long (CALLBACK *WATextBoxCanPaste)(HWND);
long (CALLBACK *WATextBoxCanUndo)(HWND);
long (CALLBACK *WACheckBoxGetState)(HWND);
long (CALLBACK *WACheckBoxSetState)(HWND, long);
long (CALLBACK *WARebarAddBand)(HWND, HWND, char *, long, long, long);
long (CALLBACK *WARebarRemoveBand)(HWND, long);
long (CALLBACK *WARebarGetXSize)(HWND);
long (CALLBACK *WARebarGetYSize)(HWND);
long (CALLBACK *WARebarResize)(HWND);
long (CALLBACK *WARebarSetBackColor)(HWND, COLORREF);
long (CALLBACK *WARebarSetTextColor)(HWND, COLORREF);
long (CALLBACK *WARebarBandVisible)(HWND, long, long);
long (CALLBACK *WARebarGetBandsCount)(HWND);
long (CALLBACK *WARebarGetHeight)(HWND);
COLORREF (CALLBACK *WARebarGetBackGroundColor)(HWND);
long (CALLBACK *WARebarGetRowsCount)(HWND);
long (CALLBACK *WARebarGetToolTips)(HWND);
COLORREF (CALLBACK *WARebarGetTextColor)(HWND);
long (CALLBACK *WARebarGetPalette)(HWND);
HIMAGELIST (CALLBACK *WARebarGetImageList)(HWND);
void (CALLBACK *WAPagerDisplaySetSize)(LPNMPGCALCSIZE, LPSIZE);
long (CALLBACK *WAPagerMaximizeX)(HWND, long);
long (CALLBACK *WAPagerMaximizeY)(HWND, long);
HWND (CALLBACK *WAPagerGetNotifiedChild)(long);
long (CALLBACK *WAPagerSetBackColor)(HWND, COLORREF);
COLORREF (CALLBACK *WAPagerGetBackColor)(HWND);
long (CALLBACK *WAPagerGetBorderSize)(HWND);
long (CALLBACK *WAPagerGetButtonSize)(HWND);
long (CALLBACK *WAPagerGetScrollPos)(HWND);
long (CALLBACK *WAPagerGetOrientation)(HWND);
long (CALLBACK *WAPagerSetOrientation)(HWND, long);
long (CALLBACK *WAPagerChangeOrientation)(HWND, LPNMPGCALCSIZE, long, LPSIZE);
long (CALLBACK *WAClientResize)(HWND, long, long, long, long);
HWND (CALLBACK *WAClientGetActiveChild)(HWND);
HWND (CALLBACK *WAClientSetNextChild)(HWND);
HWND (CALLBACK *WAClientSetPreviousChild)(HWND);
long (CALLBACK *WAClientTileHorizontal)(HWND);
long (CALLBACK *WAClientTileVertical)(HWND);
long (CALLBACK *WAClientTileCascade)(HWND);
long (CALLBACK *WAClientTileArrangeIconic)(HWND);
long (CALLBACK *WARadioButtonGetState)(HWND);
long (CALLBACK *WARadioButtonSetState)(HWND, long);
long (CALLBACK *WAListViewAddCol)(HWND, char *, long, long);
long (CALLBACK *WAListViewSetColWidth)(HWND, long, long);
long (CALLBACK *WAListViewGetColWidth)(HWND, long);
long (CALLBACK *WAListViewSetScroll)(HWND, long, long);
long (CALLBACK *WAListViewClear)(HWND);
long (CALLBACK *WAListViewDetachImageList)(HWND);
long (CALLBACK *WAListViewAddItem)(HWND, char *, long, long);
long (CALLBACK *WAListViewDeleteItem)(HWND, long);
long (CALLBACK *WAListViewSetSubItem)(HWND, char *, long, long);
long (CALLBACK *WAListViewSetSubItemImage)(HWND, long, long, long);
long (CALLBACK *WAListViewGetSubItemImage)(HWND, long, long);
long (CALLBACK *WAListViewEditValidated)(long);
char * (CALLBACK *WAListViewGetEditResult)(long);
long (CALLBACK *WAListViewItemCount)(HWND);
long (CALLBACK *WAListViewSelItemCount)(HWND);
long (CALLBACK *WAListViewMultiSelFirstItem)(HWND);
long (CALLBACK *WAListViewGetItemSelState)(HWND, long);
HWND (CALLBACK *WAListViewSetEditModeOn)(HWND, long, long);
long (CALLBACK *WAListViewSetItemSel)(HWND, long);
long (CALLBACK *WAListViewSetItemHighlight)(HWND, long, long);
long (CALLBACK *WAListViewSetItemFocus)(HWND, long);
long (CALLBACK *WAListViewGetItemUnderCursor)(HWND);
long (CALLBACK *WAListViewGetFirstFocusItem)(HWND);
long (CALLBACK *WAListViewGetSelItem)(HWND, long);
char * (CALLBACK *WAListViewGetSelItemText)(HWND, long);
long (CALLBACK *WAListViewSetSelItemText)(HWND, char *, long);
long (CALLBACK *WAListViewCheckBoxItemDoubleClick)(HWND);
char * (CALLBACK *WAListViewGetItemText)(HWND, long, long);
HICON (CALLBACK *WAListViewGetItemIcon)(HWND, long, long);
long (CALLBACK *WAListViewGetNotifiedColumnIndex)(long);
long (CALLBACK *WAListViewSort)(HWND, long, PFNLVCOMPARE);
long (CALLBACK *WAListViewReOrder)(HWND);
char * (CALLBACK *WAListViewGetHeaderLabel)(HWND, long);
long (CALLBACK *WAListViewGetHeaderPosition)(HWND, long);
long (CALLBACK *WAListViewSetHeaderPosition)(HWND, long, long);
long (CALLBACK *WAListViewSetBackColor)(HWND, COLORREF);
COLORREF (CALLBACK *WAListViewGetBackColor)(HWND);
COLORREF (CALLBACK *WAListViewGetTextBackColor)(HWND);
COLORREF (CALLBACK *WAListViewGetTextColor)(HWND);
long (CALLBACK *WAListViewGetToolTips)(HWND);
long (CALLBACK *WAListViewGetTopIndex)(HWND);
long (CALLBACK *WAListViewGetCountPerPage)(HWND);
HWND (CALLBACK *WAListViewGetEditControl)(HWND);
long (CALLBACK *WAListViewGetExStyle)(HWND);
HWND (CALLBACK *WAListViewGetSysHeader)(HWND);
long (CALLBACK *WAListViewGetHotCursor)(HWND);
HIMAGELIST (CALLBACK *WAListViewGetImageList)(HWND, long);
long (CALLBACK *WAListViewSetItemCheckbox)(HWND, long, long);
long (CALLBACK *WAListViewGetItemCheckbox)(HWND, long);
long (CALLBACK *WAListViewIsCheckboxNotify)(HWND, long);
long (CALLBACK *WAListViewFindItem)(HWND, char *);
long (CALLBACK *WAListViewFindSubItem)(HWND, char *, long, long);
long (CALLBACK *WAListViewBeginDrag)(long, HWND, LPPOINT);
long (CALLBACK *WAListViewMoveDrag)(LPPOINT);
void (CALLBACK *WAListViewEndDrag)(HWND);
long (CALLBACK *WAListViewPasteAutoEdit)(HWND, long, long);
long (CALLBACK *WATreeViewAddItem)(HWND, char *, HTREEITEM, HTREEITEM, long, long, long, long);
long (CALLBACK *WATreeViewSetToolTips)(HWND, long);
long (CALLBACK *WATreeViewGetToolTips)(HWND);
long (CALLBACK *WATreeViewSetIndent)(HWND, long);
long (CALLBACK *WATreeViewRemoveItem)(HWND, HTREEITEM);
long (CALLBACK *WATreeViewSetBackColor)(HWND, COLORREF);
long (CALLBACK *WATreeViewGetExpandingState)(long);
HTREEITEM (CALLBACK *WATreeViewGetExpandingItem)(long);
HTREEITEM (CALLBACK *WATreeViewGetDeletedItem)(long);
long (CALLBACK *WATreeViewSetItemIcon)(HWND, HTREEITEM, long);
long (CALLBACK *WATreeViewSetItemExpandedState)(HWND, HTREEITEM, long);
long (CALLBACK *WATreeViewGetItemExpandedState)(HWND, HTREEITEM);
long (CALLBACK *WATreeViewSetSingleExpandState)(HWND, long);
HTREEITEM (CALLBACK *WATreeViewGetSelectedItem)(HWND);
HTREEITEM (CALLBACK *WATreeViewGetItemFromPos)(HWND, long, long);
long (CALLBACK *WATreeViewSetSelectedItem)(HWND, HTREEITEM);
char * (CALLBACK *WATreeViewGetItemText)(HWND, HTREEITEM);
long (CALLBACK *WATreeViewSetItemText)(HWND, HTREEITEM, char *);
HTREEITEM (CALLBACK *WATreeViewGetItemParent)(HWND, HTREEITEM);
HTREEITEM (CALLBACK *WATreeViewGetRoot)(HWND);
long (CALLBACK *WATreeViewGetItemCount)(HWND);
long (CALLBACK *WATreeViewGetVisibleCount)(HWND);
HTREEITEM (CALLBACK *WATreeViewGetFirstItemChild)(HWND, HTREEITEM);
HTREEITEM (CALLBACK *WATreeViewGetNextItem)(HWND, HTREEITEM);
HTREEITEM (CALLBACK *WATreeViewGetPreviousItem)(HWND, HTREEITEM);
long (CALLBACK *WATreeViewSearchItemText)(HWND, HTREEITEM, char *);
long (CALLBACK *WATreeViewSearchChildPartialText)(HWND, HTREEITEM, char *);
long (CALLBACK *WATreeViewGetChildItemsCount)(HWND, HTREEITEM);
long (CALLBACK *WATreeViewGetSelChildItemPos)(HWND, HTREEITEM, HTREEITEM);
long (CALLBACK *WATreeViewGetItemLevel)(HWND, HTREEITEM);
COLORREF (CALLBACK *WATreeViewGetBackColor)(HWND);
HWND (CALLBACK *WATreeViewGetEditControl)(HWND);
HIMAGELIST (CALLBACK *WATreeViewGetImageList)(HWND, long);
long (CALLBACK *WATreeViewGetIndent)(HWND);
COLORREF (CALLBACK *WATreeViewGetInsertMarkColor)(HWND);
COLORREF (CALLBACK *WATreeViewGetLineColor)(HWND);
COLORREF (CALLBACK *WATreeViewGetTextColor)(HWND);
long (CALLBACK *WATreeViewGetItemHeight)(HWND);
long (CALLBACK *WATreeViewGetScrollTime)(HWND);
long (CALLBACK *WATreeViewGetItemTextRect)(HWND, HTREEITEM, LPRECT);
long (CALLBACK *WATreeViewGetItemRect)(HWND, HTREEITEM, LPRECT);
long (CALLBACK *WAComboBoxAddItem)(HWND, char *, long);
long (CALLBACK *WAComboBoxDeleteItem)(HWND, long);
long (CALLBACK *WAComboBoxReset)(HWND);
long (CALLBACK *WAComboBoxSetMaxLen)(HWND, long);
long (CALLBACK *WAComboBoxCount)(HWND);
long (CALLBACK *WAComboBoxGetIndex)(HWND);
long (CALLBACK *WAComboBoxSetIndex)(HWND, long);
char * (CALLBACK *WAComboBoxGetItem)(HWND, long);
char * (CALLBACK *WAComboBoxGetCurrentItem)(HWND);
long (CALLBACK *WAComboBoxItemExist)(HWND, char *);
long (CALLBACK *WAComboBoxGetItemData)(HWND, long);
void (CALLBACK *WAComboBoxSaveInIniFile)(HWND, char *, char *, char *);
void (CALLBACK *WAComboBoxFillFromIniFile)(HWND, char *, char *);
long (CALLBACK *WAListBoxAddItem)(HWND, char *, long);
long (CALLBACK *WAListBoxReset)(HWND);
long (CALLBACK *WAListBoxSetHorzScrollWidth)(HWND, long);
long (CALLBACK *WAListBoxSetColumnsWidth)(HWND, long);
long (CALLBACK *WAListBoxCount)(HWND);
long (CALLBACK *WAListBoxGetTopIndex)(HWND);
long (CALLBACK *WAListBoxSetTopIndex)(HWND, long);
long (CALLBACK *WAListBoxSetItemData)(HWND, long, long);
long (CALLBACK *WAListBoxGetItemData)(HWND, long);
long (CALLBACK *WAListBoxIsItemSelected)(HWND, long);
long (CALLBACK *WAListBoxGetSelItemIndex)(HWND);
long (CALLBACK *WAListBoxSetIndex)(HWND, long);
char * (CALLBACK *WAListBoxGetCurrentItem)(HWND);
char * (CALLBACK *WAListBoxGetItem)(HWND, long);
long (CALLBACK *WAListBoxDeleteItem)(HWND, long);
long (CALLBACK *WAListBoxReplaceItem)(HWND, long, char *);
long (CALLBACK *WAListBoxReplaceSelItem)(HWND, char *);
void (CALLBACK *WAListBoxProcessDrag)(HWND, long, long, long);
long (CALLBACK *WAListBoxSelItemDown)(HWND);
long (CALLBACK *WAListBoxSelItemUp)(HWND);
long (CALLBACK *WAListBoxSelItemRemove)(HWND);
long (CALLBACK *WAListBoxItemExist)(HWND, char *);
long (CALLBACK *WAListBoxItemUnderCursor)(HWND);
long (CALLBACK *WAScrollBarGetMinRange)(HWND, long);
long (CALLBACK *WAScrollBarGetMaxRange)(HWND, long);
long (CALLBACK *WAScrollBarGetPageRange)(HWND, long);
long (CALLBACK *WAScrollBarSetPageRange)(HWND, long, long);
void (CALLBACK *WAScrollBarShowHide)(HWND, long, long, long);
long (CALLBACK *WAScrollBarSetMinMaxRange)(HWND, long, long, long);
void (CALLBACK *WADumpBoxResize)(HWND, long, long, long, long);
long (CALLBACK *WADumpBoxScrollDown)(HWND, long, long, long);
long (CALLBACK *WADumpBoxScrollUp)(HWND, long, long, long);
long (CALLBACK *WADumpBoxGetVisibleLines)(HWND, long, long);
long (CALLBACK *WADumpBoxGetVisibleColumns)(HWND, long, long);
...
char * (CALLBACK *WAMenuGetString)(HMENU, long);
long (CALLBACK *WAMenuEnable)(HMENU, long, long);
long (CALLBACK *WAMenuSetDefaultItem)(HMENU, long);
long (CALLBACK *WAMenuSetItemState)(HMENU, long, long);
long (CALLBACK *WAMenuSetItemType)(HMENU, long, long);
long (CALLBACK *WAMenuSetItemText)(HMENU, char *, long);
long (CALLBACK *WAScreenWidth)(void);
long (CALLBACK *WAScreenHeight)(void);
void (CALLBACK *WAScreenRectToClient)(HWND, LPRECT);
...
long (CALLBACK *WACursorEnable)(long);
char * (CALLBACK *WAIniReadKey)(char *, char *, char *);
long (CALLBACK *WAIniReadBoolKey)(char *, char *, char *);
long (CALLBACK *WAIniWriteSection)(char *, char *, char *);
long (CALLBACK *WAIniDeleteKey)(char *, char *, char *);
long (CALLBACK *WAIniWriteKey)(char *, char *, char *, char *);
long (CALLBACK *WAMathGenerateRandomNumber)(long);
char * (CALLBACK *WADateGetNow)(long);
char * (CALLBACK *WADateGetYear)(void);
char * (CALLBACK *WADateGetMonth)(void);
char * (CALLBACK *WADateGetDay)(void);
char * (CALLBACK *WADateGetHour)(void);
char * (CALLBACK *WADateGetMinutes)(void);
char * (CALLBACK *WADateGetSeconds)(void);
char * (CALLBACK *WADateGetFormat)(char *);
char * (CALLBACK *WADateGetTimeFormat)(char *);
long (CALLBACK *WAStringIsLabel)(char *);
long (CALLBACK *WAStringIsHexaDecimal)(char *);
long (CALLBACK *WAStringIsDecimal)(char *, long);
long (CALLBACK *WAStringIsLabelChar)(char *);
long (CALLBACK *WAStringIsDigitChar)(char *);
long (CALLBACK *WAStringIsHexaChar)(char *);
long (CALLBACK *WAStringIsAlphaChar)(char *);
long (CALLBACK *WAStringIsBlankChar)(char *);
long (CALLBACK *WAStringIsOpenBracketChar)(char *);
long (CALLBACK *WAStringIsUnderLineChar)(char *);
long (CALLBACK *WAStringIsDotChar)(char *);
long (CALLBACK *WAStringIsCommaChar)(char *);
long (CALLBACK *WAStringIsQuoteChar)(char *);
long (CALLBACK *WAStringIsArobasChar)(char *);
long (CALLBACK *WAStringIsEOL)(char *);
char * (CALLBACK *WAStringNumberComplement)(long,long);
char * (CALLBACK *WAStringHexNumberComplement)(long,long);
char * (CALLBACK *WAStringBinNumberComplement)(long,long);
long (CALLBACK *WAStringCount)(char *, char *, long, long);
char * (CALLBACK *WAStringReplace)(char *, char *,char *, long, long, long);
char * (CALLBACK *WAStringHex32)(long);
char * (CALLBACK *WAStringHex16)(long);
char * (CALLBACK *WAStringHex8)(long);
long * (CALLBACK *WAStringSplit)(char *, char *);
long (CALLBACK *WAStringGetSplitUBound)(long *);
char * (CALLBACK *WAStringGetSplitElement)(char *, long *, long);
void (CALLBACK *WAStringReleaseSplit)(long *);
char * (CALLBACK *WAStringJoin)(char *, long *, char *, long,long);
long (CALLBACK *WAStringFree)(char *);
long (CALLBACK *WAStringLen)(char *);
char * (CALLBACK *WAStringCat)(char *, char *);
char * (CALLBACK *WAStringDecToString)(long);
long (CALLBACK *WAStringStringToDec)(char *);
long (CALLBACK *WAStringStringToHex)(char *);
long (CALLBACK *WAStringCountLines)(char *, long);
long (CALLBACK *WAStringGetLinesOffsets)(char *);
long (CALLBACK *WAStringFilterNonPrintableChars)(long,long);
char * (CALLBACK *WAStringLeft)(char *, long);
char * (CALLBACK *WAStringRight)(char *, long Dat);
char * (CALLBACK *WAStringTrim)(char *);
char * (CALLBACK *WAStringLTrim)(char *);
char * (CALLBACK *WAStringRTrim)(char *);
long (CALLBACK *WAStringInStr)(char *, long, char *, long);
char * (CALLBACK *WAStringMid)(char *, long, long);
char * (CALLBACK *WAStringUpperCase)(char *);
char * (CALLBACK *WAStringLowerCase)(char *);
char * (CALLBACK *WAStringReverse)(char *);
char * (CALLBACK *WAStringSpace)(long);
char * (CALLBACK *WAStringString)(long, long);
long (CALLBACK *WAStringIsNumeric)(char *);
void (CALLBACK *WAStringFillHexBytes)(void *, char *, long, long, long, long, long);
void (CALLBACK *WAStringFillHexWords)(void *, char *, long, long, long, long, long);
void (CALLBACK *WAStringFillHexDWords)(void *, char *, long, long, long, long, long);
void (CALLBACK *WAStringFileNameToLabel)(char *);
long (CALLBACK *WAFileGetWriteTime)(char *, LPFILETIME);
long (CALLBACK *WAFileGetCreationTime)(char *, LPFILETIME);
long (CALLBACK *WAFileGetAccessedTime)(char *, LPFILETIME);
char * (CALLBACK *WAFileGetExtension)(char *);
char * (CALLBACK *WAFileRemoveExtension)(char *);
char * (CALLBACK *WAFileReplaceExtension)(char *, char *);
char * (CALLBACK *WAFileGetDirectory)(char *);
char * (CALLBACK *WAFileGetFileName)(char *);
HANDLE (CALLBACK *WAFileOpenR)(char *);
HANDLE (CALLBACK *WAFileOpenW)(char *, long);
HANDLE (CALLBACK *WAFileOpenWAppend)(char *);
long (CALLBACK *WAFileClose)(HANDLE);
HANDLE (CALLBACK *WAFileCreateEmpty)(char *, long);
long (CALLBACK *WAFileWriteBuffer)(HANDLE, LPCVOID, long);
long (CALLBACK *WAFileWriteLine)(HANDLE, char *);
long (CALLBACK *WAFileIsDirectory)(char *);
long (CALLBACK *WAFileGetSize)(char *);
long (CALLBACK *WAFileExist)(char *);
long (CALLBACK *WAFileIsReadOnly)(char *);
long (CALLBACK *WAFileIsUnix)(char *);
HGLOBAL (CALLBACK *WAFileLoadIntoMem)(char *, long *);
long (CALLBACK *WAFileSaveFromMem)(char *, long, long);
char * (CALLBACK *WAFileDir)(char *, long);
long (CALLBACK *WARegistryUpdateKey)(HKEY, char *, char *, char *, long);
long (CALLBACK *WARegistryDeleteKey)(HKEY, char *, char *, long);
char * (CALLBACK *WARegistryGetKeyValue)(HKEY, char *, char *);
void (CALLBACK *WAGDIFillWindow)(HWND, COLORREF);
void (CALLBACK *WAGDIFillWindowFromBrush)(HWND, HBRUSH);
void (CALLBACK *WAGDIFillWindowFromBrushAndhDC)(HWND, HDC, HBRUSH);
HBRUSH (CALLBACK *WAGDICreateColorBrush)(COLORREF);
HFONT (CALLBACK *WAGDIObtainFont)(char *, long, HWND, long, long);
void (CALLBACK *WAGDIDrawHorzSep)(HWND, long, long, long);
void (CALLBACK *WAGDIDrawVertSep)(HWND, long, long, long);
void (CALLBACK *WAGDIDrawLine)(HWND, long, long, long, long, COLORREF);
void (CALLBACK *WAGDIDrawLineXOR)(HWND, long, long, long, long, COLORREF);
long (CALLBACK *WAGDIDrawPixel)(HWND, long, long, long);
void (CALLBACK *WAGDIWriteText)(HDC, long, long, char *, long, HFONT, long, long);
void (CALLBACK *WAGDIWriteClippedText)(HDC, long, long, long, long, char *, long, HFONT, long, long);
long (CALLBACK *WAGDIGetTextWidth)(HWND, HFONT, char *);
long (CALLBACK *WAGDIGetTextHeight)(HWND, HFONT, char *);
long (CALLBACK *WAGDIGetFontWidth)(HWND, HFONT);
long (CALLBACK *WAGDIGetFontHeight)(HWND, HFONT);
HDC (CALLBACK *WAGDICreateBackDC)(LPBACKDC);
void (CALLBACK *WAGDIDestroyBackDC)(LPBACKDC);
long (CALLBACK *WAGDIBlitBackDC)(LPRECT, LPBACKDC);
long (CALLBACK *WAGDIColorCalcLuminosity)(COLORREF, long);
HFONT (CALLBACK *WAGDIGetSerif)(void);
HFONT (CALLBACK *WAGDIGetSerif10)(void);
HFONT (CALLBACK *WAGDIGetCourierNew9)(void);
long (CALLBACK *WAControlNextHook)(HWND, UINT, WPARAM, LPARAM);
long (CALLBACK *WAControlSendMessage)(HWND, long, long);
long (CALLBACK *WAControlClientTop)(HWND);
long (CALLBACK *WAControlClientLeft)(HWND);
long (CALLBACK *WAControlClientWidth)(HWND);
long (CALLBACK *WAControlClientHeight)(HWND);
long (CALLBACK *WAControlBringToTop)(HWND);
long (CALLBACK *WAControlBringToBottom)(HWND);
long (CALLBACK *WAControlSetTopMost)(HWND);
long (CALLBACK *WAControlRemTopMost)(HWND);
void (CALLBACK *WAControlRefresh)(HWND);
void (CALLBACK *WAControlRefreshLocal)(HWND);
void (CALLBACK *WAControlRepaint)(HWND);
long (CALLBACK *WAControlResize)(HWND, long, long, long, long);
long (CALLBACK *WAControlFreeze)(HWND, long);
void (CALLBACK *WAControlBound)(HWND, long *, long *, long *, long *);
long (CALLBACK *WAControlEnable)(HWND, long);
long (CALLBACK *WAControlVisible)(HWND, long);
long (CALLBACK *WAControlIsVisible)(HWND);
long (CALLBACK *WAControlIsEnabled)(HWND);
char * (CALLBACK *WAControlGetText)(HWND);
long (CALLBACK *WAControlGetTextLen)(HWND);
long (CALLBACK *WAControlSetText)(HWND, char *);
long (CALLBACK *WAControlGetNotifiedMsg)(long);
HWND (CALLBACK *WAControlGetNotifiedhWnd)(long);
long (CALLBACK *WAControlGetNotifiedID)(long);
long (CALLBACK *WAControlTop)(HWND);
long (CALLBACK *WAControlLeft)(HWND);
long (CALLBACK *WAControlWidth)(HWND);
long (CALLBACK *WAControlHeight)(HWND);
HWND (CALLBACK *WAControlGetHwndFromPoint)(void);
long (CALLBACK *WAControlGetNotifiedCommand)(long);
long (CALLBACK *WAControlGetXMousePos)(long);
long (CALLBACK *WAControlGetYMousePos)(long);
HFONT (CALLBACK *WAControlGetFont)(HWND);
HICON (CALLBACK *WAControlGetIcon)(HWND, long);
long (CALLBACK *WAControlGetHotKey)(HWND);
long (CALLBACK *WAControlSetFont)(HWND, HFONT);
long (CALLBACK *WAControlSetFontNoRedraw)(HWND, HFONT);
long (CALLBACK *WAControlIsWindowChild)(HWND);
char * (CALLBACK *WAControlGetClassName)(HWND);
long (CALLBACK *WAControlSetClassCursor)(HWND, HCURSOR);
long (CALLBACK *WAControlGetWindowState)(HWND);
long (CALLBACK *WAControlClose)(HWND);
long (CALLBACK *WAComDlgChooseColor)(HWND, long *);
char * (CALLBACK *WAComDlgGetOpenFileName)(HWND, char *, char *, long);
char * (CALLBACK *WAComDlgGetSaveFileName)(HWND, char *, char *);
long (CALLBACK *WAComDlgChooseFont)(HWND, char *, long, long, LPLOGFONT, LPCHOOSEFONT);
char * (CALLBACK *WAComDlgBrowseForFolder)(HWND, char *);
char * (CALLBACK *WAComDlgParseMultiFilesSelection)(char *, long (CALLBACK *)(char *, long), long, long);
long (CALLBACK *WAWinsockInit)(LPWSADATA, long);
long (CALLBACK *WAWinsockUnInit)(void);
SOCKET (CALLBACK *WASocketCreate)(void);
long (CALLBACK *WASocketDestroy)(SOCKET, HWND);
long (CALLBACK *WASocketConnect)(SOCKET, LPSOCKADDR_IN, long, HWND, char *, long, long);
long (CALLBACK *WASocketGetPort)(SOCKET, LPSOCKADDR_IN);
long (CALLBACK *WASocketListen)(SOCKET, HWND, long, long);
SOCKET (CALLBACK *WASocketAcceptConnection)(SOCKET, LPSOCKADDR_IN);
long (CALLBACK *WASocketSendASCIIDatasCR)(SOCKET, char *);
long (CALLBACK *WASocketSendUnknownDatas)(SOCKET, long, long);
long (CALLBACK *WASocketGetRevcLen)(SOCKET);
char * (CALLBACK *WASocketReceiveASCIIDatas)(SOCKET);
long (CALLBACK *WASocketReceiveUnknownDatas)(SOCKET, long *, long);
SOCKET (CALLBACK *WAFTPInitiatePort)(SOCKET, LPSOCKADDR_IN, HWND, long);
char * (CALLBACK *WAFTPGetEntryDate)(char *);
char * (CALLBACK *WAFTPGetEntryFileName)(char *);
char * (CALLBACK *WAFTPGetEntryFileAttributes)(char *);
char * (CALLBACK *WAFTPGetEntryFileSize)(char *);
long (CALLBACK *WAFTPIsEntryDir)(char *);
long (CALLBACK *WAMiscClipBoardCopyText)(char *);
char * (CALLBACK *WAMiscClipBoardPasteText)(void);
long (CALLBACK *WAMiscClipBoardIsEmpty)(void);
void (CALLBACK *WAMiscShellAddFileToRecents)(char *);
long (CALLBACK *WAMiscWaitEvents)(HWND, HACCEL, HWND);
long (CALLBACK *WAMiscMsgBox)(HWND, char *, long);
long (CALLBACK *WAMiscSendBroadCastMsg)(long);
void (CALLBACK *WAMiscDoEvents)(HWND,HACCEL,HWND);
HRESULT (CALLBACK *WAMiscObtainGUID)(LPGUID);
HGLOBAL (CALLBACK *WAMiscAllocMem)(long);
long (CALLBACK *WAMiscFreeMem)(HGLOBAL);
void (CALLBACK *WAMiscCopyMemLoop)(void *, void *, long, long, long);
void (CALLBACK *WAMiscCopyMemWithOffsets)(void *, void *, long, long, long);
long (CALLBACK *WAMiscGetOSClass)(void);
long (CALLBACK *WAMiscObtainExtendedFunctions)(void);	/* Reserved for future extensions */
char * (CALLBACK *WAMMGetWindowLangGUID)(HWND);
char * (CALLBACK *WAMMGetWindowLangInclude)(HWND);
char * (CALLBACK *WAMMGetWindowLangDoubleSlash)(HWND);
char * (CALLBACK *WAMMGetWindowLangComment)(HWND);
char * (CALLBACK *WAMMGetWindowLangMultiComment)(HWND);
char * (CALLBACK *WAMMGetWindowLangMultiCommentEnd)(HWND);
char * (CALLBACK *WAMMGetWindowLangProc)(HWND);
char * (CALLBACK *WAMMGetWindowLangEndp)(HWND);
long (CALLBACK *WAMMGetWindowLangProcInterlace)(HWND);
long (CALLBACK *WAMMGetWindowLangProcOrphan)(HWND);
char * (CALLBACK *WAMMGetWindowLangProcOpenBlock)(HWND);
char * (CALLBACK *WAMMGetWindowLangProcCloseBlock)(HWND);
char * (CALLBACK *WAMMGetWindowLangFileName)(HWND);
char * (CALLBACK *WAMMGetWindowLangIncludeName)(HWND);
char * (CALLBACK *WAMMGetWindowLangIncludeNameFoot)(HWND);
char * (CALLBACK *WAMMDecodeRelativePaths)(char *);
char * (CALLBACK *WAMMRemoveRelativePaths)(char *);
char * (CALLBACK *WAMMEncodeRelativePaths)(char *);
void (CALLBACK *WAMMRunUserCommand)(long);
void (CALLBACK *WAMMRunCommandScript)(char *, long);
long (CALLBACK *WAMMRunDOSCmd)(char *, char *, char *, char *);
void (CALLBACK *WAMMRunDOSCmdCapture)(char *, char *, char *);
long (CALLBACK *WAMMDisplayHelpFile)(char *, char *);
char * (CALLBACK *WAMMGetWindowPath)(void);
long (CALLBACK *WAMMIsFileWorkSpace)(char *);
long (CALLBACK *WAMMIsFileProject)(char *);
long (CALLBACK *WAMMGetCurrentChildState)(void);
HWND (CALLBACK *WAMMGotoFileLine)(char *, long, long);
void (CALLBACK *WAMMFocusOnFile)(char *, long);
char * (CALLBACK *WAMMGetFileNameFromTreeViewItem)(HTREEITEM);
char * (CALLBACK *WAMMGetLabelFromTreeViewItem)(HTREEITEM);
long (CALLBACK *WAMMOpenUnknownFile)(char *, long);
char * (CALLBACK *WAMMHexToDec)(char *);
char * (CALLBACK *WAMMDecToHex)(char *);
char * (CALLBACK *WAMMDecToBin)(char *);
char * (CALLBACK *WAMMHexToBin)(char *);
char * (CALLBACK *WAMMBinToDec)(char *);
char * (CALLBACK *WAMMBinToHex)(char *);
char * (CALLBACK *WAMMHexToFlt)(char *);
char * (CALLBACK *WAMMFltToHex)(char *);
char * (CALLBACK *WAMMGetProcedureList)(char *);
char * (CALLBACK *WAMMGetLineFromFile)(HANDLE, long);
HWND (CALLBACK *WAMMCreateNewWindow)(void);
void (CALLBACK *WAMMClearWindow)(HWND);
void (CALLBACK *WAMMReloadWindow)(HWND);
void (CALLBACK *WAMMCloseWindow)(HWND);
void (CALLBACK *WAMMCloseAllWindows)(void);
void (CALLBACK *WAMMSaveAllWindows)(void);
void (CALLBACK *WAMMPrintWindow)(HWND, long);
char * (CALLBACK *WAMMSaveWindow)(HWND);
void (CALLBACK *WAMMUndo)(HWND);
void (CALLBACK *WAMMRedo)(HWND);
void (CALLBACK *WAMMCut)(HWND);
void (CALLBACK *WAMMCopy)(HWND);
long (CALLBACK *WAMMCopyFilePathName)(HWND);
long (CALLBACK *WAMMCopyEntireText)(HWND);
void (CALLBACK *WAMMPaste)(HWND);
void (CALLBACK *WAMMDeleteSel)(HWND);
void (CALLBACK *WAMMDeleteLine)(HWND);
void (CALLBACK *WAMMDeleteToStart)(HWND);
void (CALLBACK *WAMMDeleteToEnd)(HWND);
void (CALLBACK *WAMMSelectLine)(HWND);
void (CALLBACK *WAMMSelectAll)(HWND);
long (CALLBACK *WAMMSelectProc)(HWND);
void (CALLBACK *WAMMFindNext)(HWND);
void (CALLBACK *WAMMFindPrevious)(HWND);
void (CALLBACK *WAMMFindSelection)(HWND);
void (CALLBACK *WAMMGotoTop)(HWND);
void (CALLBACK *WAMMGotoBottom)(HWND);
void (CALLBACK *WAMMGotoLine)(HWND, long);
void (CALLBACK *WAMMGotoMatchingBracket)(HWND);
void (CALLBACK *WAMMGotoPrevWord)(HWND, long);
void (CALLBACK *WAMMGotoNextWord)(HWND, long);
void (CALLBACK *WAMMGotoPrevLetter)(HWND, long);
void (CALLBACK *WAMMGotoNextLetter)(HWND, long);
void (CALLBACK *WAMMGotoPrevLine)(HWND, long);
void (CALLBACK *WAMMGotoNextLine)(HWND, long);
void (CALLBACK *WAMMGotoPrevPage)(HWND, long);
void (CALLBACK *WAMMGotoNextPage)(HWND, long);
void (CALLBACK *WAMMGetMiniChildStruct)(HWND, LPMINICHILDDAT);
char * (CALLBACK *WAMMGetIniFilePathName)(long);
char * (CALLBACK *WAMMGetQuickDirectory)(long);
void (CALLBACK *WAMMGetContext)(LPADDINCONTEXT);
char * (CALLBACK *WAMMGetcurrentLine)(HWND);
char * (CALLBACK *WAMMSelectCurrentWord)(HWND);
char * (CALLBACK *WAMMGetCurrentWord)(HWND);
void (CALLBACK *InsertText)(HWND, char *);
void (CALLBACK *WAMMInsertLine)(HWND, char *);
void (CALLBACK *WAMMInsertLines)(HWND, long);
void (CALLBACK *WAMMSetText)(HWND, char *);
long (CALLBACK *WAMMGetCaretRealXCoordinate)(HWND);
long (CALLBACK *WAMMGetCaretRealYCoordinate)(HWND);
void (CALLBACK *WAMMSetFocusInsideWindow)(HWND);
void (CALLBACK *WAMMRestoreMDIFromSysTray)(void);
long (CALLBACK *WAMMInstallHookProc)(long, long);
void (CALLBACK *WAMMUnInstallHookProc)(long, long, long);
long (CALLBACK *WAMMGetCurrentLineNumber)(HWND);
long (CALLBACK *WAMMGetCurrentColNumber)(HWND);
char * (CALLBACK *WAMMGetCurrentLineText)(HWND);
char * (CALLBACK *WAMMGetLineText)(HWND, long);
void (CALLBACK *WAMMWriteToOutputBox)(char *);
void (CALLBACK *WAMMEnumSourceWindows)(long);
void (CALLBACK *WAMMAddInKillZombie)(long);
long (CALLBACK *WAMMSpAddInIsAvailable)(char *);
char * (CALLBACK *WAMMMiscInputBox)(HWND, char *, long, char *, long, long, char *);
long (CALLBACK *WAMMIsChildReadOnly)(HWND);
void (CALLBACK *WAMMSetChildReadOnly)(HWND, long);
HWND (CALLBACK *WAMMCreateCustomChildDialog)(char *, void (CALLBACK *)(HWND), WNDPROC);
HWND (CALLBACK *WAMMCreateCodeMax)(long, long, long, long, HWND, void (CALLBACK *)(HWND));
