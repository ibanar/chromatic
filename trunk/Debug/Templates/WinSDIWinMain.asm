...
WinMain 		proc	hInst:dword,hPrevInst:dword,CmdLine:dword,CmdShow:dword
			...
			mov	hWnd,eax
			invoke	LoadAccelerators,hInst,ACCELERATORS_0
			mov	hAccel,eax
			invoke	LoadMenu,hInst,MENUS_0
...
StartLoop:		invoke	GetMessage,addr msg,0,0,0
			...
			test	ecx,ecx
			jz	NoAccelerators
			invoke	TranslateAccelerator,hWnd,ecx,addr msg
NoAccelerators:		invoke	TranslateMessage,addr msg
